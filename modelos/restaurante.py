...
class Restaurante:
    ...
    def listar_restaurantes(cls):
        print(f"{'Nome restaurante'.ljust(25)} | {'Categoria'.ljust(25)} | {'Avaliacao'.ljust(25)} | {'Status'}")
    ...
    def receber_avaliacao(self, cliente, nota):
        if 0 <= nota <= 5:
            ...
            print('Por favor, insira uma nota válida entre 0 e 5')

    @property
    def media_avaliacoes(self):
        if not self._avaliacao:
            return 'Ainda não há avaliação para este restaurante'
